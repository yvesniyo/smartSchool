...
<student-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/students') }}'" inline-template>
        ...
        <div class="col">
            <div class="card shadow-sm border-0">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-sm pull-right m-b-0 ml-2" href="{{ url('admin/students/export') }}" role="button"><i class="fa fa-file-excel-o"></i>&nbsp; {{ trans('admin.student.actions.export') }}</a>
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'nfc'">{{ trans('admin.student.columns.nfc') }}</th>
                                    <th is='sortable' :column="'parent_phone_number'">{{ trans('admin.student.columns.parent_phone_number') }}</th>
                                    <th is='sortable' :column="'is_active'">{{ trans('admin.student.columns.is_active') }}</th>

...
class FillPermissionsForAttendancy extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAttendancy constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.attendancy',
            'admin.attendancy.index',
            'admin.attendancy.create',
            'admin.attendancy.show',
            'admin.attendancy.edit',
            'admin.attendancy.delete',
            'admin.attendancy.bulk-delete',
        ]);
